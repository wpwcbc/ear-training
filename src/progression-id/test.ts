...
const ANSWER_QUALITIES = CHORD_QUALITIES.filter((quality) =>
	["maj7", "m7", "7", "m7b5", "dim7"].includes(quality),
);
...
const handleAnswer = (): void => {
	...
	if (
		selectedDegree === state.currentQuestion.chord.degree &&
