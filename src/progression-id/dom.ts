...
export const dom = {
	...
	elDegreeSelectA: getById<HTMLSelectElement>("degreeSelectA"),
	elQualitySelectA: getById<HTMLSelectElement>("qualitySelectA"),
	elDegreeSelectB: getById<HTMLSelectElement>("degreeSelectB"),
	elQualitySelectB: getById<HTMLSelectElement>("qualitySelectB"),
