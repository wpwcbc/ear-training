import type { QualityOption, VoicingOption, VoicingId } from "./types.js";
...
export const getQualityOption = (id: string): QualityOption | undefined =>
	QUALITY_OPTIONS.find((option) => option.id === id);

export const getVoicingOption = (id: VoicingId): VoicingOption | undefined =>
	VOICING_OPTIONS.find((option) => option.id === id);
