...
export const dom = {
    ...
    elDegreeSelectA: getById("degreeSelectA"),
    elQualitySelectA: getById("qualitySelectA"),
    elDegreeSelectB: getById("degreeSelectB"),
    elQualitySelectB: getById("qualitySelectB"),
