...
export const renderRecords = () => {
    ...
    if (!filteredTests.length) {
        ...
        header.append(buildCell("Progression", "stats-cell stats-label"), buildCell("Avg time"), buildCell("Avg attempts"), buildCell("Date"));
    ...
    const grouped = groupRecords(questions, (record) => grouping === "quality" ? record.chordQuality : record.chordDegree);
    ...
    const header = document.createElement("div");
    header.className = "stats-row stats-header";
    header.append(buildCell(grouping === "quality" ? "Quality" : "Degree", "stats-cell stats-label"), buildCell("Avg time"), buildCell("Avg attempts"), buildCell("Questions"));
    table.appendChild(header);
