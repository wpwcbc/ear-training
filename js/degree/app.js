...
import { addProgressionRow, getMode, loadDefaultProgression, markProgressionCustom, readMode1Config, readMode2Config, renderMode2Rows, showModePanels, } from "./setup.js";
import { replayCurrent, resetLiveDisplay, setStatus, setTestRunning, startTest, stopTest, } from "./test.js";
const updateModeUI = () => {
    const mode = getMode();
    showModePanels(mode);
    resetLiveDisplay();
